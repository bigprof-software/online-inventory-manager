<?php
	...
	$x = new StdClass;
	$x->TableTitle = "Outgoing items over time";
	...
	$config_array = array(
		'reportHash' => 't5n1ge4zqdrj43lzjibf',
		'request' => $_REQUEST,
		'groups_array' => $groups_array,
		'override_permissions' => false,
		'title' => 'Outgoing items over time',
		'custom_where' => '`transactions`.`transaction_type`=\'Outgoing\'',
		'table' => 'transactions',
		'label' => 'item',
		'group_function' => 'sum',
		'label_title' => 'Item',
		'value_title' => 'Sum of Transactions',
		'thousands_separator' => ',',
		'decimal_point' => '.',
