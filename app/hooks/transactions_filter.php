...
<?php }else{ ?>
	...
	<button class="btn btn-lg btn-default pull-right search_mode" type="submit" name="Filter_x" value="1">Switch to advanced search mode</button>
			...
			<div class="page-header"><h1>
				<a href="transactions_view.php" style="text-decoration: none; color: inherit;">
					<img src="resources/table_icons/book_keeping.png"> 					Transactions Filters</a>
			</h1></div>

		
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
		
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Transaction date</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Transaction date</label></div>
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;">
		...
		<div class="col-md-8 col-lg-6 vspacer-md">
			...
			<input type="hidden" id="lookupoperator_3" name="FilterOperator[3]" value="equal-to">
			<input type="hidden" id="filterfield_3" name="FilterValue[3]" value="<?php echo htmlspecialchars($FilterValue[3]); ?>" size="3">
		</div>
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;">
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Batch</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Batch</label></div>
		...
		<div class="col-md-8 col-lg-6 vspacer-md">
			...
			<input type="hidden" id="lookupoperator_4" name="FilterOperator[4]" value="equal-to">
			<input type="hidden" id="filterfield_4" name="FilterValue[4]" value="<?php echo htmlspecialchars($FilterValue[4]); ?>" size="3">
		</div>
		...
		$j(function(){
			...
			$j("#filter_4").select2({
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ return { s: term, p:page, t:"transactions", f:"batch" }; },
					results: function (resp, page) { return resp; }
				}
			}).on('change', function(e){
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;">
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Storage section</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Storage section</label></div>
		...
		<div class="col-md-8 col-lg-6 vspacer-md">
			...
			<input type="hidden" id="lookupoperator_5" name="FilterOperator[5]" value="equal-to">
			<input type="hidden" id="filterfield_5" name="FilterValue[5]" value="<?php echo htmlspecialchars($FilterValue[5]); ?>" size="3">
		</div>
	...
	<div class="row" style="border-bottom: dotted 2px #DDD;">
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Transaction type</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Transaction type</label></div>
		...
		<div class="col-xs-10 col-sm-11 col-md-8 col-lg-6">
			...
			<div class="radio">
				<label>
					 <input type="radio" name="FilterValue[6]" class="filter_6" value='Incoming'>Incoming				</label>
			</div>
	 
			<div class="radio">
				<label>
					 <input type="radio" name="FilterValue[6]" class="filter_6" value='Outgoing'>Outgoing				</label>
			</div>
	 
			<div class="radio">
				<label>
					 <input type="radio" name="FilterValue[6]" class="filter_6" value='Expired'>Expired				</label>
			</div>
	 
			<div class="radio">
				<label>
					 <input type="radio" name="FilterValue[6]" class="filter_6" value='Damaged'>Damaged				</label>
			</div>
	 		</div>
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Quantity</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Quantity</label></div>
