		...
		$pcConfig = array(
			'transactions' => array(   
				'item' => array(   
					...
					'sortable-fields' => array(0 => '`transactions`.`id`', 1 => '`transactions`.`transaction_date`', 2 => '`transactions`.`item`', 3 => '`transactions`.`batch`', 4 => '`transactions`.`section`', 5 => '`transactions`.`transaction_type`', 6 => '`transactions`.`quantity`'),
					'records-per-page' => 10,
					'default-sort-by' => 1,
			...
			'items' => array(   
				'category' => array(   
					...
					'sortable-fields' => array(0 => '`items`.`id`', 1 => '`items`.`item`', 2 => '`items`.`code`', 3 => '`items`.`balance`', 4 => '`items`.`category`'),
					'records-per-page' => 10,
			...
			'batches' => array(   
				'item' => array(   
					...
					'sortable-fields' => array(0 => '`batches`.`id`', 1 => '`batches`.`item`', 2 => '`batches`.`supplier`', 3 => '`batches`.`batch_no`', 4 => '`batches`.`manufacturing_date`', 5 => '`batches`.`expiry_date`', 6 => '`batches`.`balance`'),
					'records-per-page' => 10,
					'default-sort-by' => 0,
					'default-sort-direction' => 'desc',
					'open-detail-view-on-click' => true,
