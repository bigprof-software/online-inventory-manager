	...
	$lookups = array(
		'transactions' => array(
			'item' => array(
				'parent_table' => 'items',
				'parent_pk_field' => 'id',
				'parent_caption' => '`items`.`item`',
				'parent_from' => '`items` LEFT JOIN `categories` as categories1 ON `categories1`.`id`=`items`.`category` ',
				'filterers' => array(),
				'custom_query' => '',
			...
			'batch' => array(
				...
				'parent_pk_field' => 'id',
				'parent_caption' => '`batches`.`batch_no`',
				'parent_from' => '`batches` LEFT JOIN `items` as items1 ON `items1`.`id`=`batches`.`item` LEFT JOIN `suppliers` as suppliers1 ON `suppliers1`.`id`=`batches`.`supplier` ',
				'filterers' => array('item' => 'item'),
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
				'not_null' => false
			...
			'section' => array(
				'parent_table' => 'sections',
				'parent_pk_field' => 'id',
				'parent_caption' => '`sections`.`section`',
				'parent_from' => '`sections` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
		...
		'batches' => array(
			...
			'supplier' => array(
				...
				'parent_pk_field' => 'id',
				'parent_caption' => '`suppliers`.`supplier`',
		...
		'items' => array(
			'category' => array(
				...
				'parent_pk_field' => 'id',
				'parent_caption' => '`categories`.`category`',
