	...
	*/
	...
	$schema = array(   
		'transactions' => array(   
			...
			'transaction_date' => array('appgini' => 'DATE '),
			'item' => array('appgini' => 'INT unsigned '),
			'batch' => array('appgini' => 'INT unsigned '),
			'section' => array('appgini' => 'INT unsigned '),
			'transaction_type' => array('appgini' => 'VARCHAR(40) not null '),
			'quantity' => array('appgini' => 'DECIMAL(10,2) default \'1.00\' ')
		),
		'batches' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'item' => array('appgini' => 'INT unsigned '),
			'supplier' => array('appgini' => 'INT unsigned '),
			'batch_no' => array('appgini' => 'VARCHAR(40) '),
			'manufacturing_date' => array('appgini' => 'DATE '),
			'expiry_date' => array('appgini' => 'DATE '),
			'balance' => array('appgini' => 'DECIMAL(10,2) default \'0.00\' ')
		),
		'suppliers' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'supplier' => array('appgini' => 'VARCHAR(40) '),
			'email' => array('appgini' => 'VARCHAR(80) '),
			'phone' => array('appgini' => 'VARCHAR(40) '),
			'contact_person' => array('appgini' => 'VARCHAR(40) '),
			'country' => array('appgini' => 'VARCHAR(40) ')
		),
		'categories' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'category' => array('appgini' => 'VARCHAR(100) ')
		),
		'items' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
		...
		'sections' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'section' => array('appgini' => 'VARCHAR(40) ')
		)
	);
